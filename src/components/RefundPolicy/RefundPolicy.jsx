...
<p className="policy-para">......</p>
      <div className="each-policy-container">
        ...
        <p className="policy-para">Any amount once added to the My Wicket11 account of user can't be 
        ...
        <p className="policy-para"> The individuals using the services and Fun Features provided by My Wicket11 
        ...
        <p className="policy-para">My Wicket11 reserves the rights to refund the transaction amount to the user 
        ...
        <p className="policy-para">In case of any unforeseen event, e.g. Force majeure, event cancellation,
